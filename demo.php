...
<body>
  <nav>
    <div > <a class="nav__logo" href="demo.php">Fast Airlines</a></div>
    <ul class="nav__links">
      <li class="link"><a href="login_page.php">Home</a></li>
      <li class="link"><a href="login_page.php">Flight Status</a></li>
      <li class="link"><a href="login_page.php">Book</a></li>
      <li class="link"><a href="login_page.php">Cancel Booking</a></li>
      <li class="link"><a href="login_page.php">About</a></li>
      <li class="link"><a href="login_page.php">Contact</a></li>
    </ul>
    <button class="btn"><a href="login_page.php">Login</a></button>
  </nav>
  ...
  <div class="flight-btn">
    <button class="btn" style="padding-left: 10%;padding-right: 10%;"><a href="login_page.php">Book Now</a></button>
  </div>
